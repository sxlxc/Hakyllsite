...
It was mentioned in a footnote of [@chalermsook_approximating_2022] that a general version of normalized min-cut is used in [this paper](https://drops.dagstuhl.de/storage/00lipics/lipics-vol064-isaac2016/LIPIcs.ISAAC.2016.33/LIPIcs.ISAAC.2016.33.pdf), which in turn mentioned that normalized min-cut is an ordinary subroutine in MWU frameworks. It is not the readers' fault to not know MWU. It's you authors' fault not explicitly to mention the intuition. This writing style is toxic and causes huge waste of reader's time. This is far off the standard of IPCO.